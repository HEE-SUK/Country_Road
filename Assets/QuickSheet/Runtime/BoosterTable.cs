...
/// 
[System.Serializable]
public class BoosterTable : ScriptableObject 
{
    ...
    public BoosterTableData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new BoosterTableData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public BoosterTableData FindByKey(string key)
    //{
