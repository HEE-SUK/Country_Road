...
/// 
[System.Serializable]
public class CheckPointTable : ScriptableObject 
{
    ...
    public CheckPointTableData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new CheckPointTableData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public CheckPointTableData FindByKey(string key)
    //{
