...
/// 
[System.Serializable]
public class SectionTable : ScriptableObject 
{
    ...
    public SectionTableData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new SectionTableData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public SectionTableData FindByKey(string key)
    //{
